...
import ManageSelect from "./ManageSelect/ManageSelect";
...
const HomeTopBar = () => {
  ...
  return (
    <AppBar position="static" color="transparent" className={classes.topBar}>
      ...
      {history.location.pathname !== "/players" ? (
        <Toolbar className={classes.toolbar}>
          <div className={styles.topBarBottom__left}>
            <div className={styles.topBar__sort}>
              ...
              <Typography
                color={
                  activeFilter === "name" ? "textPrimary" : "textSecondary"
                }
                variant="body1"
                component="span"
              ...
              <Typography
                color={
                  activeFilter === "date" ? "textPrimary" : "textSecondary"
                }
                variant="body1"
                component="span"
